...
class StockMouvementPolicy
{
   ...
   public function viewAny(User $user): bool
    ...
    {
        return $stockMovement->canBeApproved() && ($user->can('approve stock movements') || $user->hasRole('Admin') || $user->hasRole('Super Admin'));
    }

    public function reject(User $user, StockMouvement $stockMovement): bool
    {
        return $stockMovement->canBeRejected() && ($user->can('reject stock movements') || $user->hasRole('Admin') || $user->hasRole('Super Admin'));
    }
}
